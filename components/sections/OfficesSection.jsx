            ...
            >
              <div style={{ position: "relative", height: 180 }}>
                ...
                <div style={{
                  position:   "absolute",
                  inset:      0,
                  background: "linear-gradient(to top, rgba(20,18,16,0.65) 0%, transparent 60%)",
                }} />
                <div style={{ position: "absolute", bottom: "1rem", left: "1rem" }}>
                  <p style={{ fontFamily: font.serif, fontSize: "1.3rem", fontWeight: 700, color: "#fff", lineHeight: 1 }}>{o.city}</p>
                  <p style={{ fontFamily: font.sans, color: "rgba(255,255,255,0.75)", fontSize: "0.75rem", marginTop: 3 }}>{o.country}</p>
                </div>
              </div>
              <div style={{ backgroundColor: C.bg, padding: "1rem 1.25rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                <span style={{ width: 6, height: 6, borderRadius: "50%", backgroundColor: C.copper, display: "inline-block", flexShrink: 0 }} />
                <span style={{ fontFamily: font.sans, color: C.muted, fontSize: "0.8rem" }}>{o.detail}</span>
              </div>
            </motion.div>
          ))}
        </motion.div>
