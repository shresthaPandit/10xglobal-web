...
export default function InsightsSection() {
  return (
    <section style={{ backgroundColor: C.bg, padding: "6rem 1.5rem" }}>
        ...
        >
          {INSIGHTS.map((a) => (
            <motion.article
              ...
              whileHover={{ y: -4, boxShadow: "0 0 0 1.5px rgba(193,127,62,0.5), 0 12px 40px rgba(193,127,62,0.12), 0 12px 40px rgba(20,18,16,0.08)" }}
            >
              ...
              <div style={{ padding: "1.5rem" }}>
                ...
                <h3 style={{ fontFamily: font.serif, fontSize: "1.2rem", fontWeight: 700, color: C.ink, lineHeight: 1.3, marginBottom: "0.75rem" }}>
                  {a.title}
                </h3>
                <p style={{ fontFamily: font.sans, color: C.muted, fontSize: "0.85rem", lineHeight: 1.7 }}>
                  {a.excerpt}
                </p>
                <p style={{ marginTop: "1.25rem", fontFamily: font.sans, color: C.copper, fontSize: "0.85rem", fontWeight: 500 }}>
                  Read more →
                </p>
              </div>
            </motion.article>
